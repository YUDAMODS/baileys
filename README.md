...
```json
"depencies": {
  "@whiskeysockets/baileys": "github:YUDAMODS/baileys"
}
```
## Import
```javascript
...
await client.relayMessage(m.chat, {
  productMessage {
    ...
    buttons: [
      {
        name: "cta_url",
        buttonParamsJson: "{\"display_text\":\"YudaMods\",\"url\":\"https://example.com\"}"
      }
    ],
